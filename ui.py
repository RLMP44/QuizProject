...
class QuizInterface:
        # Ensures that the quiz_brain input that we get is from the QuizBrain class
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(text="Score: 0", font=("Arial", 20), bg=THEME_COLOR, fg="white")
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"You've reached the end of the quiz! "
                                                            f"You got {self.quiz.score} out of 10 right.")
    ...
    def check_true(self):
        ...
        # can condense to self.give_feedback(self.quiz.check_answer("True"))
